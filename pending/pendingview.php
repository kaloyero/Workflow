...
<h1>
<i class="icon-thumbs-up-alt animation-expandUp"></i>Listado Pending<br><small>Listado de los Eventos en estado Pending</small>
</h1>
</a>
</div>
...
<div class="tab-content">
	<div class="tab-pane active" id="example-tabs2-home">
		...
		<div class="table-responsive">
			<div ng-controller="datatableControllerPending as lista">

			    <table datatable dt-options="lista.dtOptions" dt-columns="lista.dtColumns" dt-instance="lista.dtInstance" class="table table-bordered table-hover pendingEstilo"></table>
			</div>
